...
[^Places_of_articulation]: [Wikipedia on places of articulation](http://en.wikipedia.org/wiki/Place_of_articulation){:lang="en"}
...
[^Alveolar_consonants]: [Wikipedia on alveolar consonants](http://en.wikipedia.org/wiki/Alveolar_consonant){:lang="en"}
